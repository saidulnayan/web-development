                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0">Want to see a live preview?</h4>
                        <p class="mb-0 font-weight-normal d-none d-sm-block">Check out the website in just one click!</p>
                      </div>
                      <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                        <span>
                          <a href="http://127.0.0.1:8000/" target="_blank" class="btn btn-outline-light btn-rounded get-started-btn">Go to WEB</a>
                        </span>
                      </div>
                    </div>
                  </div>
