  ...
  padding: 2em;
    ...
    <body>
        <div class="iphone">
            ...
            <form action="/cart/checkout/order" class="form" method="POST">
            {{csrf_field()}}
              <div>
                <h2>Address</h2>
                ...
                <div class="card">
                 <address>
                  @if($cartname)
                  <textarea name="address" rows="2" style="color: white; background-color: #FC8080; width:100%; height: 100%; border: none; font-size: 15px; font-weight: bold;">
                    {{$cartname->name}}
              ...
              <fieldset>
                ...
                <div class="form__radios">
                  ...
                  <div class="form__radio">
                    ...
                    <input checked id="paypal" name="payment" type="radio" value="paypal" />
                  </div>
                  ...
                  <div class="form__radio">
                    ...
                    <input id="mastercard" name="payment" type="radio" value="mastercard"/>
                  </div>
                  <div class="form__radio">
                    <label for="visa"><svg class="icon">
                        <use xlink:href="#icon-visa" />
                      </svg>Cask On Delivery</label>
                    <input  id="visa" name="payment" type="radio" value="cash" />
                  </div>
                </div>
              </fieldset>
              ...
              <div>
                ...
                <table>
                  ...
                  <tfoot>
                    <tr>
                      <td>Total</td>
                      @if($sumprice)<td id="tpop" align="right">${{$sumprice}}</td>@endif
                    </tr>
                  </tfoot>
                </table>
              </div>
              ...
              <div>
                <button class="button button--full" type="submit" id="ckout"><svg class="icon">
