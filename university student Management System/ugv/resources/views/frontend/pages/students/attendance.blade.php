...
<div class="main-panel">
    <div class="content-wrapper">
      ...
      <div class="page-header">
        <h3 class="page-title">Attendance Marks</h3>
      ...
      <div class="row">
        ...
        <table class=" table-striped table-bordered" style="width: 90%; margin: 0 auto; ">
          ...
          <tbody>
            ...
            @foreach($sttds as $key=>$data)
            <tr style="width: 100%; "> 
              <td style="text-align: center; padding: 4px 0;">{{$data->studentid}} </td>
              <td style="text-align: center; padding: 4px 0;">{{$data->studentname}} </td>
              <td style="text-align: center; padding: 4px 0;">{{$data->dept}} - {{$data->semester}} sem {{$data->category}} </td>
              <td style="text-align: center; padding: 4px 0;">{{$data->dailyattmarks}}</td>
            </tr>
            @endforeach
