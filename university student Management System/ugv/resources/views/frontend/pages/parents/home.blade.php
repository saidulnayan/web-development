@extends('frontend.layouts.parent_master')
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8" style="padding: 10px 0;">
                        <h4 class="mb-1 mb-sm-0">Welcome <span style="color: #13ddd0"><b>Parent</b></span></h4>
                        <p class="mb-0 font-weight-normal d-none d-sm-block">to Your Parental portal</p>
                      </div>
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Fees Due</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">CGPA</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Remarks</h6>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      <div class="text-md-center text-xl-left">
                        <h6 class="mb-1">Saidul Islam Nayan</h6>
                        <h6 class=" mb-1">Registration No: 1122334455</h6>
                        <h6 class=" mb-1">Roll: 1181629</h6>
                        <h6 class="mb-1">Semester: 8</h6>
                        <p class="mb-1">Section: A</p>
                        <p class="mb-1">Session: Winter-2019</p>
                      </div>
                      
                    </div>
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                    
                        <h6 class=" mb-1">Computer Science & Engineering (CSE)</h6>
