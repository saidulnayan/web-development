                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8" style="padding: 10px 0;">
                        <h4 class="mb-1 mb-sm-0">Welcome <span style="color: #13ddd0"><b>Sir</b></span></h4>
                        <p class="mb-0 font-weight-normal d-none d-sm-block">to Your Teachers Profile Page</p>
                      </div>
