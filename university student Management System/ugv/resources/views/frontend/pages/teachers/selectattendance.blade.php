        ...
        <table class=" table-striped table-bordered" style="width: 90%; margin: 0 auto; border-spacing: 10px 0;">
          ...
          <tbody>
            ...
            <tr style="width: 100%; "> 
              ...
              <td style="text-align: center; padding: 10px 0;"><a href="/teachers/attendance/{{$data->id}}/daily" style="text-decoration: none; color: white;" ><button class="badge badge-primary">Attendance</button></a></td>
            </tr>
            @endforeach
