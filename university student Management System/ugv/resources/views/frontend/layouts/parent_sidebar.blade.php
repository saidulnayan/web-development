...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="http://127.0.0.1:8000/parents/home"><i class="mdi mdi-view-grid" style="color: white;"></i></a>
          <a class="sidebar-brand brand-logo-mini" href="http://127.0.0.1:8000/parents/home"><i class="mdi mdi-view-grid" style="color: white;"></i></a>
        </div>
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="http://127.0.0.1:8000/parents/home">
