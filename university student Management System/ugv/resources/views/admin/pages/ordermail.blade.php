            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        @foreach($data as $key=>$data)
                            ...
                            <td> {{$data->payment}} </td>                          
                            <td>
                                <a href="" style="text-decoration: none; color: green; pointer-events: none; "><div class="badge badge-outline-primary">Email</div></a>
                            </td>
                            <td>
                                <div class="badge badge-outline-success" style=" color: green; border: none; pointer-events: none; {{$data->disable}}"><input type="text" readonly class="btn btn-success btn-sm" style="color: green; background-color: #191C24; width: 75px; padding: 7.5px;" onclick="setrole(this);" value="{{$data->accept}}" name="{{"Accept".$key}}"></div>
                            </td>
                            <td>
                                <a href="" style="text-decoration: none; color: red; pointer-events: none;" onclick="return confirm('Are You Sure You Want To Delete?');"><div class="badge badge-outline-danger">Delete</div></a>
                            </td>
                            </tr>
                  ...
                  <input type="submit" class="btn btn-primary btn-lg btn-block" onclick="setmark();" style="pointer-events: none;" value="Save Changes">
                </form>
                </div>
              </div>
            </div>
...
<div class="form-popup" id="myForm">
  <form action="/orders/email/{{$odata}}/send" class="form-container" method="POST">
    {{csrf_field()}}
    ...
    <a href="/orders" style="text-decoration: none; color: white;"><button type="button" class="btn cancel">Close</button></a>
  </form>
</div>
@endif
