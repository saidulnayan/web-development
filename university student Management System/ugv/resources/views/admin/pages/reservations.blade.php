                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive" style="overflow: auto; max-height: 90vh;">
                    <table class="table">
                      ...
                      <tbody>
                        <form action="/reservations/status/update" class="form-container" method="POST">
                            {{csrf_field()}}
                        @foreach($rdata as $key=>$data)
                            ...
                            overflow: hidden; text-overflow: ellipsis;" onclick="isEllipsisActive(this);"> {{$data->message}} </td>
                          
                            <td>
                                <a href="/reservations/email/{{$data->id}}" style="text-decoration: none; color: green"><div class="badge badge-outline-primary">Email</div></a>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="/reservations/delete/{{$data->id}}" style="text-decoration: none; color: red" onclick="return confirm('Are You Sure You Want To Delete?');"><div class="badge badge-outline-danger">Delete</div></a>
                            </td>
                            </tr>
