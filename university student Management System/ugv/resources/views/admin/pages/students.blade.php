        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="card-title" >All Students</h4><br>
        ...
        <table class=" table-striped table-bordered" style="width: 90%; margin: 0 auto; ">
          ...
          <tbody>
            ...
            <tr style="width: 100%; "> 
              ...
              <td style="text-align: center; padding: 4px 0;">{{$data->studentname}}</td>
              <td style="text-align: center; padding: 4px 0;">{{$data->dept}} - {{$data->sem}} sem {{$data->category}} </td>
              <td style="text-align: center; padding: 4px 0;"><a href="/admin/students/{{$data->id}}/delete" style="text-decoration: none;" onclick="return confirm('Are You Sure You Want To Delete?');"><button type="submit" class="btn btn-primary btn-lg btn-block">Delete</button></a></td>
            </tr>
            @endforeach
      ...
      <div class="row" >
        <div class="col-md-6" style="margin: 0 auto; text-align:center;">
          <div class="form-group row" >
            ...
            <div class="col-sm-8" >
                <a href="/admin/students/promote" style="text-decoration: none;" onclick="return confirm('All the permited students will be promoted to next semester.');"><button type="submit" class="btn btn-primary btn-lg btn-block">Promote All Students</button></a>
            </div>
          </div>
        </div>
      </div>
