                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="teacherid" required class="form-control" style="background-color: white; color:black;" value="{{$data->teacherid}}"/>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="teachername" required class="form-control" style="background-color: white; color:black;" value="{{$data->teachername}}"/>
                        </div>
                      </div>
                    </div>
                  </div>
